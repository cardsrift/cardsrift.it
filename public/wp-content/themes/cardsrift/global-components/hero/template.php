...
<section class="hero-slider relative h-dvh">
	<div class="tw-container  text-white gap-8 mx-auto hero_text_w z-10 absolute top-0 left-0 right-0 bottom-0 flex justify-center items-start flex-col">
		...
		<a class="btn btn-xs sm:btn-sm md:btn-md lg:btn-lg" target="<?= $cta['target']; ?>" href="<?= $cta['url']; ?>"><?= $cta['title']; ?></a>
	</div>
	...
	<div class="swiper heroSlider">
		...
		<div class="swiper-wrapper">
			...
			<?php foreach ($slides as $index => $slide): ?>
				...
				<div class="swiper-slide h-[900px]">
