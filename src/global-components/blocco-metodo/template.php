...
/**
 * BLOCCO METODO — "come lavoro" raccontato in concreto (niente numeri, niente vanto):
 * titolo a sinistra, a destra una lista di passaggi (verbo + descrizione) con filetti.
 * Riutilizzabile per qualsiasi "come funziona" pacato. Campi: tema, eyebrow, titolo,
 * intro (opz.), voci[] (label, testo), pattern (true/false).
 */
