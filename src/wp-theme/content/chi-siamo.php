...
return [
	...
	[
		...
		'voci'    => [
			['label' => __('La controllo', 'cardsrift'), 'testo' => __('Apro, verifico e giudico le condizioni sulla scala del mercato — NM, LP, MP, HP — sempre per difetto. Se è Lightly Played, nella scheda leggi Lightly Played.', 'cardsrift')],
			['label' => __('La fotografo', 'cardsrift'), 'testo' => __('Se ha valore la scansiono fronte e retro: quello che vedi nella scheda è il pezzo che ricevi, non un’immagine di catalogo.', 'cardsrift')],
	...
	[
		...
		'testo'     => __('<b>La fiducia non si inventa: si costruisce un pacco alla volta.</b> Le stesse carte che trovi qui le vendo su Cardmarket — il posto dove i collezionisti si fidano dei numeri, non delle promesse. Il portale è nuovo; la cura con cui spedisco è quella di sempre.', 'cardsrift'),
		'stats'     => [
	...
	[
		...
		'faq'     => [
			...
			['domanda' => __('Come giudichi le condizioni?', 'cardsrift'),           'risposta' => __('Uso la scala standard del mercato — NM, LP, MP, HP — applicata per difetto. Se una carta è Lightly Played la chiamo così, senza arrotondare per vendere meglio.', 'cardsrift')],
			...
			['domanda' => __('Posso vendervi le mie carte?', 'cardsrift'),           'risposta' => __('Sì. Le valuto sui prezzi correnti di Cardmarket e ti faccio un’offerta senza impegno. Trovi tutti i dettagli nella pagina dedicata.', 'cardsrift')],
	...
	[
		...
		'testo'     => __('<b>Hai carte che non guardi più?</b> Da me trovano un’altra collezione dove stare. Le valuto con calma, ti dico tutto prima — e se l’offerta non ti convince, ci siamo salutati bene lo stesso.', 'cardsrift'),
	...
	[
		...
		'testo'     => __('Il canale Telegram è ancora piccolo, e va bene così: restock, nuove uscite e qualche chicca prima che altrove. Si entra gratis, senza spam — e da qui cresciamo insieme.', 'cardsrift'),
