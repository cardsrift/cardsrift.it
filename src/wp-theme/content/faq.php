...
return [
	...
	[
		...
		'faq'     => [
			...
			['domanda' => __('Quali giochi trattate?', 'cardsrift'),                  'risposta' => __('Pokémon e Magic: i giochi che conosciamo meglio e su cui possiamo garantire davvero. Gli altri arriveranno con calma.', 'cardsrift')],
