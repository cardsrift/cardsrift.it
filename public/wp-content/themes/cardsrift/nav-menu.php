<nav class="main-menu bg-green container mx-auto  lg:pt-0">
	<?php $menu_hamburger = sort_wp_nav('header'); ?>

	<ul class="inline-flex flex-1 justify-center align-center flex-col lg:flex-row  text-4">
		<?php
		...
		?>
				...
				<li class="menuItemflex inline-flex  justify-center align-center flex-col  mx-2 <?= $class ?'text-purple': 'text-black'; ?>">
					<a class=" " href="<?= $item_hamburger['url']; ?>"><?= $item_hamburger['title']; ?></a>
				</li>
			<?php else : ?>
				<li class="menuItemWChild flex justify-center align-center flex-col mx-2  relative <?= $class ?'text-purple': 'text-black'; ?>">
					<a class="" href="<?= $item_hamburger['url']; ?>"><?= $item_hamburger['title']; ?>
				</a>
				<span class="toggleMenu absolute top-0 -right-4 lg:hidden">&#43;</span>

	
							<ul class="main_menu__list hidden hover_arrow_state mt-2 ml-2 flex-col  border border-black lg:bg-purple lg:ml-0 lg:p-1 lg:absolute lg:top-4 lg:left-[50%] lg:-translate-x-[50%]">
